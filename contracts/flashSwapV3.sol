...
contract SwapExamples {
    ...
    function swapExactInputSingle(uint amountIn, address _tokenOut)
        external
    ...
    function swapExactOutputSingle(uint amountOut, uint amountInMaximum, address _tokenOut)
        external
    ...
    /// swap WETH --> USDC --> DAI
    function swapExactInputMultihop(uint amountIn,address _tokenOut)
        external
        returns (uint amountOut)
    {
        TransferHelper.safeTransferFrom(
    ...
    /// swap WETH --> USDC --> DAI
    function swapExactOutputMultihop(uint amountOut, uint amountInMaximum, uint _tokenOut)
        external
        returns (uint amountIn)
    {
        TransferHelper.safeTransferFrom(
